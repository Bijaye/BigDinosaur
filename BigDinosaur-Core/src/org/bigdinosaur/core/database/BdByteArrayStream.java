...
public class BdByteArrayStream extends java.io.OutputStream
implements DataOutput {

    protected byte[] buffer;
    protected int    count;

    public BdByteArrayStream() {
        this(128);
    }

    public BdByteArrayStream(int size) {
    ...
    public BdByteArrayStream(byte[] buffer) {
        this.buffer = buffer;
    }
     ...
     * length value.
     */
    public BdByteArrayStream(InputStream input,
    ...
    public BdByteArrayStream(InputStream input) throws IOException {

...
/**
 * Interface supported by {@link org.bigdinosaur.io.WritableComparable}
...
public abstract class BinaryComparable implements Comparable<BinaryComparable> {
   ...
   * @see org.bigdinosaur.io.WritableComparator#compareBytes(byte[],int,int,byte[],int,int)
   */
   ...
   * @see org.bigdinosaur.io.WritableComparator#hashBytes(byte[],int)
   */
  public int hashCode() {

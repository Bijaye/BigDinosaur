...
public class TestContent {
    ...
    public static final String USERNAMEdimple = "mydimple";
    public static final String PASSWORDdimple = "mydimple";
    ...
    public static final String ACCESS_TOKEN_ENDPOINT = "http://localhost:8080/Big-Dinosaur/api/token";
    public static final String ACCESS_TOKEN_ENDPoint1 = "http://localhost:8080/Big-Dinosaur/api/authztoken";
    public static final String AUTHORIZATION_ENPOINT = "http://localhost:8080/Big-Dinosaur/api/authz";
    public static final String REDIRECT_URL = "http://localhost:8080/Big-Dinosaur/api/redirect";
    public static final String REDIRECT_URL1 = "http://localhost:8080/Big-Dinosaur/api/redirect1";

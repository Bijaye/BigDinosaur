package com.bigdinosaur.sampleprogram;
...
public class Cluster1ServerNonBlocking
{
    public static void main(String[] args)
    {
        try
        {
            ...
            System.out.println("Non-blocking Server created on port  8001");
            
            Cluster1ClientNonBlocking    client=new Cluster1ClientNonBlocking();
            
            client.main(args);
             
            System.out.println("<<<< Messaged received from another server, server server to communication succedded"+client.getMessage() );
            String messagereceivedfromanotherserver=client.getMessage();
                    ...
                    try
                    {
                        ...
                        while(iterator.hasNext())
                        {
                                ...
                                operation) != 0)
                            {
                                ...
                                int length = messagereceivedfromanotherserver.length() 
                                    * 2;

...
public class Cluster3ServerNonBlocking
{
    public static void main(String[] args)
    {
        try
        {
            ...
            System.out.println("Non-blocking Server created on port  8003");
  Cluster2ClientNonBlocking    client=new Cluster2ClientNonBlocking();
            
            client.main(args);
             
            System.out.println("<<<< Messaged received from second server"+client.getMessage() );
